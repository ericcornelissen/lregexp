...
All security issues in _lRegExp_ should be reported publicly as bugs. Private
reports will be made public by the maintainers after 7 days with best-effort
attribution. Nevertheless, we will acknowledge security audits and publish
vulnerability advisories for legitimate vulnerabilities.
